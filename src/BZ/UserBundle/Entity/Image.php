<?php
// src/BZ/UserBundle/Entity/Image.php
...
/**
* BZ\UserBundle\Entity\Image
*
* @ORM\Table()
* @ORM\Entity(repositoryClass="BZ\UserBundle\Entity\ImageRepository")
...
class Image
{
    ...
    */
    private $alt;
         ...
         * @var \DateTime
         *
         * @ORM\Column(name="dateconn", type="datetime", nullable=true)
         */
        private $dateconn;
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
        ...
        */
        ...
        {
        return 'uploads/img/'.$this->getId().'.'.$this->getUrl();
        }
        /**
