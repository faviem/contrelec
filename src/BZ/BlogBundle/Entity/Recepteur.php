 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="BZ\BlogBundle\Entity\RecepteurRepository")
...
class Recepteur
{
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="BZ\BlogBundle\Entity\Message", inversedBy="recepteurs")
    * @ORM\JoinColumn(nullable=true) 
    */
    private $message;
     ...
     * Set message
     *
     * @param \BZ\BlogBundle\Entity\Message $message
     * @return Recepteur
     */
    public function setMessage(\BZ\BlogBundle\Entity\Message $message = null)
    {
     ...
     * Get message
     *
     * @return \BZ\BlogBundle\Entity\Message 
     */
