 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="BZ\BlogBundle\Entity\NiveauAlerteRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class NiveauAlerte
{
    /**
    * @ORM\OneToMany(targetEntity="BZ\ArchiveBundle\Entity\Archive", mappedBy="niveaualerte")
