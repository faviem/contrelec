<?php
// src/BZ/BlogBundle/Entity/FileRequete.php
...
/**
* BZ\BlogBundle\Entity\FileRequete
*
* @ORM\Table()
* @ORM\Entity(repositoryClass="BZ\BlogBundle\Entity\FileRequeteRepository")
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
        ...
        */
        ...
        {
        return 'uploads/Message/'.$this->getId().'.'.$this->getUrl();
        }
