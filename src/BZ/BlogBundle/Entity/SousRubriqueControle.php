...
/**
 * SousRubriqueControle
 * 
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="BZ\BlogBundle\Entity\SousRubriqueControleRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class SousRubriqueControle
{
      /**
    * @ORM\ManyToOne(targetEntity="BZ\BlogBundle\Entity\RubriqueControle",  inversedBy="sousrubriquecontroles")
    * @ORM\JoinColumn(nullable=true) 
    */
    private $rubriquecontrole;
    /**
     * @var integer
     *
    ...
    */
    ...
    /**
     * Set rubriquecontrole
     *
     * @param \BZ\BlogBundle\Entity\RubriqueControle $rubriquecontrole
     * @return SousRubriqueControle
     */
    public function setRubriquecontrole(\BZ\BlogBundle\Entity\RubriqueControle $rubriquecontrole = null)
    {
        $this->rubriquecontrole = $rubriquecontrole;

        return $this;
    }

    /**
     * Get rubriquecontrole
     *
     * @return \BZ\BlogBundle\Entity\RubriqueControle 
     */
    public function getRubriquecontrole()
    {
        return $this->rubriquecontrole;
    }
}
